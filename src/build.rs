...
pub trait Key: trace::Key + Clone + Send + Sync {}

impl<T> Key for T where T: trace::Key + Clone + Send + Sync {}

pub trait Value: trace::Value + Clone + Send + Sync {}

impl<T> Value for T where T: trace::Value + Clone + Send + Sync {}
